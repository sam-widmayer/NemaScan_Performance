...
load(file = "data/NemaScan_Performance.CeNDR2020_PowerPrecision_GAMMA.RData")
...
```{r power precision plots, eval=FALSE, include=FALSE}
summarized %>%
...
```{r power precision v varexplained, eval=FALSE, include=FALSE}
summarized %>%
  dplyr::mutate(h2 = as.numeric(levels(h2))[h2]) %>%
